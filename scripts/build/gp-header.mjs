...
@media(max-width:760px){.gp-bh-inner{height:56px;padding:0 .5rem;gap:.35rem}.gp-bh-logo{font-size:.85rem;white-space:nowrap}.gp-bh-nav{gap:.2rem;flex:none}.gp-bh-label,.gp-bh-hide-mobile{display:none}.gp-bh-link{padding:0;width:32px;height:32px;border-radius:50%;justify-content:center}.gp-bh-emoji{font-size:.9rem}.gp-bh-ui-trigger{width:34px;height:34px;padding:0;justify-content:center}.gp-bh-ui-label,.gp-bh-caret{display:none}.gp-bh-ui-menu{position:fixed;top:60px;right:.5rem;width:min(270px,calc(100vw - 1rem))}.gp-bh-theme{width:32px;height:32px}}
</style>
