...
| 3 | ep36T | 第三十六話「廃城の王」の執筆・マージ。A版「廃城の王」（第1章エピローグ編：商業ギルドの独占提案、ミラとの専属斥候契約、老人の伏線、ラストの王としての決意）と、C版「地下の光」（第2章の採掘開始）をマージするにあたり、C版の2章内容を将来に温存し、ほぼA版のプロットのみを統合・採用した正式版（T版）「廃城の王」を作成。A版とC版を `archive/` フォルダへ退避 |
